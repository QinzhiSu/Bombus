...
path = '/home/huyunan/bombus/02metagenome/midas/result/species_merge'
setwd(path)

file <- '/home/huyunan/bombus/02metagenome/midas/result/species_merge/relative_abundance.txt'
